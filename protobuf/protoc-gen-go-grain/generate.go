...
const (
	...
	actorPackage   = protogen.GoImportPath("github.com/DemetriusADS/protoactor-go/actor")
	clusterPackage = protogen.GoImportPath("github.com/DemetriusADS/protoactor-go/cluster")
)
