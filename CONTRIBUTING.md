...
- [t:actor](https://github.com/DemetriusADS/protoactor-go/labels/t%3Aactor)
- [t:remote](https://github.com/DemetriusADS/protoactor-go/labels/t%3Aremote)
- [t:cluster](https://github.com/DemetriusADS/protoactor-go/labels/t%3Acluster)
- [t:router](https://github.com/DemetriusADS/protoactor-go/labels/t%3Arouter)
- [See all labels](https://github.com/DemetriusADS/protoactor-go/labels)
...
- [community](https://github.com/DemetriusADS/protoactor-go/labels/community) - which identifies issues that the core team
...
- [nice-to-have (low-priority)](https://github.com/DemetriusADS/protoactor-go/labels/nice-to-have) - are tasks which make
...
- [bug](https://github.com/DemetriusADS/protoactor-go/labels/bug) - bugs take priority in being fixed above features. The
...
1. Make sure an issue exists in the [issue tracker](https://github.com/DemetriusADS/protoactor-go/issues) for the work you
   want to contribute.
    - If there is no ticket for it, [create one](https://github.com/DemetriusADS/protoactor-go/issues/new) first.
1. [Fork the project](https://github.com/DemetriusADS/protoactor-go#fork-destination-box) on GitHub. You'll need to create a
...
* [Proto.Actor Issue Tracker](https://github.com/DemetriusADS/protoactor-go/issues)
